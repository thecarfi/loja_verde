...
class ProdutoDAO
{
    ...
    public function salvar($produto)
    {
        ...
        // 4 - Monta o SQL
        $SQL = "INSERT INTO produtos( nome, marca, preco) 
    ...
    public function findAll()
    {
        ...
        $SQL = "SELECT codigo,nome,marca,preco FROM produtos";
        print_r($SQL);
    ...
    public function findById($codigo)
    {
        $conexao = new Conexao();
        $conn = $conexao->getConexao();
        $SQL = "SELECT codigo,nome,marca,preco FROM produtos WHERE codigo = '$codigo'";
        print_r($SQL);
        $result = $conn->query($SQL);
